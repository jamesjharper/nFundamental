...
namespace Fundamental.Interface.Wasapi.Tests
{
    ...
    public class WasapiAudioSourceTests
    {
        ...
        public class WasapiAudioSourceTestFixture : WasapiAudioSource
        {
            public WasapiAudioSourceTestFixture
                (
                    ...
                    IWasapiAudioClient wasapiAudioClient
                )
                : base(wasapiOptions, wasapiDeviceToken, wasapiAudioClientFactory, waveFormatConverter)
            {
                AudioClient = wasapiAudioClient;
            }

            protected override IWasapiAudioClient AudioClient { get; }
            ...
            public IWasapiAudioClient ActualAudioClient => base.AudioClient;
        }
        ...
        private IWasapiAudioClientFactory WasapiAudioClientFactoryFixture { get; set; }

        private IWasapiAudioClient WasapiAudioClientFixture { get; set; }
        ...
        public void SetUp()
        {
            ...
            WasapiAudioClientFactoryFixture = Substitute.For<IWasapiAudioClientFactory>();
            AudioFormatConverterWaveFormatFixture = Substitute.For<IAudioFormatConverter<WaveFormat>>();
            WasapiAudioClientFixture = Substitute.For<IWasapiAudioClient>();
        }

        private WasapiAudioSourceTestFixture GetTestFixture()
            => new WasapiAudioSourceTestFixture(WasapiOptionsFixture, DeviceTokenFixture, WasapiAudioClientFactoryFixture, AudioFormatConverterWaveFormatFixture, WasapiAudioClientFixture);
        ...
        public void CanFactoryAudioClient()
        {
            ...
            var expectedAudioClient = Substitute.For<IWasapiAudioClient>();

            WasapiAudioClientFactoryFixture
                .FactoryAudioClient(DeviceTokenFixture)
                .Returns(expectedAudioClient);

            // -> ACT:
            var audioClient = fixture.ActualAudioClient;
        ...
        public void CanDetechSupportedFormatWhenUsingSharedMode()
        {
            ...
            WasapiOptionsFixture.Value.AudioSource.DeviceAccess = DeviceAccess.Shared;
        ...
        public void CanDetechSupportedFormatWhenUsingExclusiveMode()
        {
            ...
            // Make sure the setting is set to Shared mode
            WasapiOptionsFixture.Value.AudioSource.DeviceAccess = DeviceAccess.Exclusive;
